...
variable "host_project_id" {
  type        = string
  description = "The host project ID for the cluster network (required)"
}
...
variable "datapath_provider" {
  type        = string
  description = "The desired datapath provider for this cluster. By default, uses Cilium and eBPF as proxy."
