...
It is based on below diagram in the overview at [https://cloud.google.com/vpc/docs/shared-vpc](https://cloud.google.com/vpc/docs/shared-vpc).

![shared-vpc](../../../images/shared-vpc.png)
...
Or, make those variables in `vars.tf`.
